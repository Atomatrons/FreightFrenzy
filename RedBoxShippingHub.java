...
@Autonomous(name="Red Box Shipping Hub", group="Active")
public class RedBoxShippingHub extends LinearOpMode 
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        driveTrain.strafeLeft(2.5,(float)0.7);
